<?php
/**
 * MarketHub About Page
 * Multi-Vendor E-Commerce Platform
 */

require_once 'config/config.php';

$page_title = 'About MarketHub';
        ...
        <div class="mission-content">
            ...
            <div style="text-align: center;">
                <img src="assets/images/mission-image.jpg" alt="Local vendors in Musanze District"
                     style="width: 100%; max-width: 400px; height: auto; border-radius: 16px; box-shadow: var(--shadow-lg);"
                    ...
                    <div class="hero-image">
                        <img src="assets/images/about-hero.jpg" alt="Musanze District Market" 
                             onerror="this.src='assets/images/placeholder-hero.jpg'">
                    </div>
                </div>
            </div>
        </div>
...
<section class="about-section" style="background: linear-gradient(135deg, var(--primary-color) 0%, var(--secondary-color) 100%); color: white;">
    <div class="container text-center">
        <h2 style="font-size: 2.5rem; font-weight: 700; margin-bottom: 1rem;">Ready to Join MarketHub?</h2>
